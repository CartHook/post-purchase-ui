...
export function WebFonts(_ref) {
  var children = _ref.children;
  var _useThemeConfiguratio = useThemeConfiguration(),
    typographyPrimary = _useThemeConfiguratio.typographyPrimary,
    typographySecondary = _useThemeConfiguratio.typographySecondary;
  useEffect(function () {
    var fonts = [typographyPrimary, typographySecondary].map(function (typography) {
      return [{
    ...
    }).reduce(function (fonts, typography) {
      return fonts.concat(typography);
    }, []).filter(function (font) {
      return font.fonts !== undefined && font.source !== undefined;
    }).map(function (_ref2) {
      var fonts = _ref2.fonts,
        source = _ref2.source,
        weight = _ref2.weight;
      return new FontFace(fonts, source, {
        weight: weight
      });
    });
    function loadFonts() {
      ...
      _loadFonts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Promise.all(fonts).then(function (loadedFonts) {
...
export function MaybeWebFonts(_ref3) {
